...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        binding.btnRegister.setOnClickListener {
            ...
            Log.d("REGISTER_ACTIVITY", "Registrando - Name: $name, Email: $email")
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                viewModel.uiState.collect { state ->
                    Log.d("REGISTER_ACTIVITY", "State recibido: $state")
                    ...
                    when (state) {
                        ...
                        is AuthUiState.Error -> {
                            setLoading(false)
                            Log.e("REGISTER_ACTIVITY", "Error: ${state.message}")
                        ...
                        is AuthUiState.Success -> {
                            setLoading(false)
                            Log.d("REGISTER_ACTIVITY", "Registro exitoso, navegando a Main")
